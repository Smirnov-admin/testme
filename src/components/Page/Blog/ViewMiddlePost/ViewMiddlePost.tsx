...
import './ViewMiddlePost.css'
import { Post } from '../../../../interface/interfacePosts'

function ViewMiddlePost({date, title, text, image}: Post) {
  ...
  return (
    <>
        <div className="middlePost_card">
            <div className="middlePost_content">
                <div className="middlePost_information">
                    <div className="middlePost_image">
                        <img src={image} alt="image" />
                    </div>
                    <div className="middleePost_description">
                        <p className='middlePost_date'>{date}</p>
                        <h2 className='middlePost_title'>{title}</h2>
                    </div>
                </div>
                <div className="middlePost_reaction_list">
                    <div className="middlePost_reaction_elements_biLikeAndDisLike">
                        <div className="middlePost_reaction_biLike">
                            <button onClick={countClickBiLike} className='middlePost_btnBiLike'>
                        ...
                        <div className="middlePost_reaction_disLike">
                            <button onClick={countClickDisLike} className='middlePost_btnDisLike'>
                    ...
                    <div className="middlePost_reaction_elements_bookmarkAndOther">
                        <div className="middlePost_reaction_bookmark">
                            <button className='middlePost_btnBookmark'>
                        ...
                        <div className="middlePost_reaction_other">
                            <button className='littlePost_btnOther'>
