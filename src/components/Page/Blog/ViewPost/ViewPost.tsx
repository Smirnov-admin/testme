...
function ViewPost({title, text, image}: Post) {
  ...
  return (
    <>
        <section className="viewPost_section">
            <div className="viewPost_content">
                <a href="" className='searchPosts_btnBackHome'>Home</a>
                <div className="viewPost_information">
                    <div className="viewPost_description">
                        <h2 className='viewPost_title'>{title}</h2>
                    </div>
                    <div className="viewPost_image">
                        <img src={image} alt="image" />
                    </div>
                    <div className="viewPost_description_text">
                        <p className='viewPost_text'>{text}</p>
                    </div>
                </div>
                <div className="viewPost_reaction_list">
                    <div className="viewPost_reaction_elements_biLikeAndDisLike">
                        <div className="viewPost_reaction_biLike">
                            <button onClick={countClickBiLike} className='viewPost_btnBiLike'>
                        ...
                        <div className="viewPost_reaction_disLike">
                            <button onClick={countClickDisLike} className='viewPost_btnDisLike'>
                                <svg width="20" height="20" viewBox="0 0 23 23" fill="#000" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="viewPost_reaction_elements_bookmark">
                        <div className="viewPost_reaction_bookmark">
                            <button className='viewPost_btnBookmark'>
                                <div className="viewPost_bookmark_iconAndText">
                                    ...
                                    <p className="viewPost_bookmark_Btntext">Add to favorites</p>
                                </div>
                            </button>
                        </div>
                    </div>
            ...
            <div className='viewPost_pagination_item'>
                <div className="viewPost_paggination_item_list">
                    <div className="viewPost_paggination_item_prev">
                        <button type='button' className='viewPost_bnt_pagination'>
                            <div className="viewPost_pagination_iconAndText">
                                ...
                                <p className='viewPost_pagination_text'>Prev</p>
                            </div>
                        </button>
                    </div>
                    <div className="viewPost_paggination_item_next">
                        <button type='button' className='viewPost_bnt_pagination'>
                            <div className="viewPost_pagination_iconAndText">
                                <p className='viewPost_pagination_text'>Next</p>
