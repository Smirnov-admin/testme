...
import './ViewLittlePost.css'
import { Post } from '../../../../interface/interfacePosts'

function ViewLittlePost({date, title, image}: Post) {
    ...
    <>
        <div className="littlePost_card">
            <div className="littlePost_content">
                <div className="littlePost_information">
                    <div className="littlePost_description">
                        <p className='littlePost_date'>{date}</p>
                        <h2 className='littlePost_title'>{title}</h2>
                    </div>
                    <div className="littlePost_image">
                        <img src={image} alt="image" />
                    </div>
                </div>
                <div className="littlePost_reaction_list">
                    <div className="littlePost_reaction_elements_biLikeAndDisLike">
                        <div className="littlePost_reaction_biLike">
                            <button onClick={countClickBiLike} className='littlePost_btnBiLike'>
                        ...
                        <div className="littlePost_reaction_disLike">
                            <button onClick={countClickDisLike} className='littlePost_btnDisLike'>
                    ...
                    <div className="littlePost_reaction_elements_bookmarkAndOther">
                        <div className="littlePost_reaction_bookmark">
                            <button className='littlePost_btnBookmark'>
                        ...
                        <div className="littlePost_reaction_other">
