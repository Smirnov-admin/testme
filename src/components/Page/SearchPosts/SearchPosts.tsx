...
function SearchPosts({date, title, image}: Post) {
  ...
  return (
    <>
        <section className='searchPosts_section'>
            <h1 className='searchPosts_title_item'>Search result</h1>
            <div className='searchPosts_item_list'>
                <div className="searchPosts_item">
                        <div className="searchPosts_content">
                        <div className="searchPosts_information">
                            <div className="searchPosts_image">
                                <img src={image} alt="image" />
                            </div>
                            <div className="searchPosts_description">
                                <p className='searchPosts_date'>{date}</p>
                                <h2 className='searchPosts_title'>{title}</h2>
                            </div>
                        </div>
                        <div className="searchPosts_reaction_list">
                            <div className="searchPosts_reaction_elements_biLikeAndDisLike">
                                <div className="searchPosts_reaction_biLike">
                                    <button onClick={countClickBiLike} className='searchPosts_btnBiLike'>
                                ...
                                <div className="searchPosts_reaction_disLike">
                                    <button onClick={countClickDisLike} className='searchPosts_btnDisLike'>
                            ...
                            <div className="searchPosts_reaction_elements_bookmarkAndOther">
                                <div className="searchPosts_reaction_bookmark">
                                    <button className='searchPosts_btnBookmark'>
                                ...
                                <div className="searchPosts_reaction_other">
                                    <button className='searchPosts_btnOther'>
            ...
            <div className='searchPosts_pagination_item'>
                <div className="searchPosts_paggination_item_list">
                    <div className="searchPosts_paggination_item_prev">
                        <button type='button' className='viewPost_bnt_pagination'>
                            <div className="searchPosts_pagination_iconAndText">
                                <svg width="19" height="12" viewBox="0 0 19 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.09375 11L1.09375 6M1.09375 6L6.09375 1M1.09375 6H17.5938" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <p className='searchPosts_pagination_text'>Prev</p>
                            </div>
                        </button>
                    </div>
                    <div className="searchPosts_paggination_item_next">
                        <button type='button' className='searchPosts_bnt_pagination'>
                            <div className="searchPosts_pagination_iconAndText">
                                <p className='searchPosts_pagination_text'>Next</p>
                                <svg width="20" height="12" viewBox="0 0 20 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.0312 1L18.0312 6M18.0312 6L13.0312 11M18.0312 6H1.53125" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </button>                         
                    </div>
